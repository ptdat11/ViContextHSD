...
class ViSoBERT(Model):
    def __init__(
        ...
        super().__init__(ablate, 2, n_classes, cls_weights)

        self.reply_encoder = AutoModel.from_pretrained("5CD-AI/visobert-14gb-corpus", add_pooling_layer=False)
    ...
    def forward_ablate_none(self, image, caption, comment, reply):
        ...
        reply_embed = self.reply_encoder(**reply).last_hidden_state[..., 0, :]
